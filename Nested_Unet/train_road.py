...
def train(args):
    ...
    model_s.load_state_dict(torch.load("./models/road_SearchDownSample_256_512/road_SearchDownSample_256_512_weights_epoch_30.pth"
                                         ,map_location='cpu'))
    para = model_s.arch_parameters ()
    # load pretrained model
    partial = torch.load("./models/road_SearchDownSample_256_512/road_SearchDownSample_256_512_weights_epoch_30.pth", map_location='cpu')
    model = DownSample_Decode_V1(3,3,para).to(device)
